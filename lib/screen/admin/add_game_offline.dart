...
class AddGameOffline extends StatefulWidget {
  const AddGameOffline({Key? key}) : super(key: key);

  @override
  State<AddGameOffline> createState() => _AddGameState();
}

class _AddGameState extends State<AddGameOffline> {
...
final CollectionReference ref =
      FirebaseFirestore.instance.collection('gameoffline');
